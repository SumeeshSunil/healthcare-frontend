        ...
        <div className="min-h-screen bg-slate-900 text-white flex flex-col justify-between p-8">
            ...
            <nav className="flex justify-between items-center max-w-7xl mx-auto w-full">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <h1 className="text-2xl font-extrabold tracking-tight text-white leading-none">
                            MEDICO <span className="text-teal-400 text-sm font-semibold">HEALTH</span>
                        </h1>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link
                        to="/login"
                        className="px-5 py-2.5 rounded-xl text-xs font-bold text-slate-300 hover:text-white transition"
                    >
                        Sign In
                    </Link>
                    ...
                    <Link
                        to="/register"
                        className="bg-teal-500 hover:bg-teal-400 text-slate-950 px-5 py-2.5 rounded-xl text-xs font-extrabold transition shadow"
                    >
                        Create Account
                    </Link>
            ...
            <main className="max-w-4xl mx-auto text-center space-y-6 py-20">
                ...
                <div className="flex flex-wrap justify-center gap-4 pt-4">
                    ...
                    <Link
                        to="/login"
                        className="bg-teal-500 hover:bg-teal-400 text-slate-950 font-extrabold px-8 py-4 rounded-2xl text-sm transition shadow-lg shadow-teal-500/25"
                    >
